...
VALUES ('admin', '123', 'Quản trị viên', 'admin@shop.vn', 'admin.jpg', 1, 1),
       ('khanh', '123', 'Nguyễn Khánh', 'khanh@gmail.com', 'khanh.jpg', 1, 0),
       ('an', '123', 'Bạn An', 'an@gmail.com', 'an.jpg', 1, 0);

-- ORDERS
INSERT INTO Orders (Address, Username)
VALUES ('123 Nguyễn Văn Linh, Q.7, TP.HCM', 'khanh'),
       ('45 Lê Lợi, Q.1, TP.HCM', 'an');
